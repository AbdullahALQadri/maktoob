          ...
          child: _OtpVerificationDialog(
            ...
            onVerified: () {
              ...
              if (_selectedUserType == UserType.institution) {
                ...
                // For regular users, navigate to login screen
...
/// OTP verification dialog shown after successful registration.
...
class _OtpVerificationDialogState extends State<_OtpVerificationDialog> {
  ...
  void _resendOtp() {
    if (_canResend) {
      context.read<AuthCubit>().resendOtp(login: widget.phone, purpose: 'verification');
      _startResendTimer();
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.sms_outlined, size: 32, color: AppColors.primaryColor),
              ),
              SizedBox(height: context.dynamicHeight(0.02)),
